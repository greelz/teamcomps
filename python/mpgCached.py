...
def doInserts(cacheDict, cursor):
    ...
    insertor(cursor, "singlecache", " (ChampOne, Patch, Region, Losses, Wins) ", singleChampValues)
    insertor(cursor, "doublecache", " (ChampOne, ChampTwo, Patch, Region, Losses, Wins) ", doubleChampValues)
    insertor(cursor, "triplecache", " (ChampOne, ChampTwo, ChampThree, Patch, Region, Losses, Wins) ", tripleChampValues)
    insertor(cursor, "quadruplecache", " (ChampOne, ChampTwo, ChampThree, ChampFour, Patch, Region, Losses, Wins) ", quadChampValues)
    insertor(cursor, "quintuplecache", " (ChampOne, ChampTwo, ChampThree, ChampFour, ChampFive, Patch, Region, Losses, Wins) ", quintChampValues)
