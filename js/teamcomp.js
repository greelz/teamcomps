...
function search() {
    ...
    for (var node = 0; node < champions.length; ++node) {
        var champ = champions[node].value.toLowerCase().replace(" ","");
        var champId = champions_dic[champ];
        if (champId) {
